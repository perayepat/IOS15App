...
//MARK: - Canvas
///This allows us to draw compose and animate mutiple elements
///this gives us a perfomance gain that will give us more control
///Importing svg code into swift to use it as a shape
import SwiftUI

struct HexagonView: View {
    var body: some View {
        Canvas{ context , size in
            context.fill(path(in: CGRect(x: 0, y: 0, width: size.width, height: size.height)), with:
